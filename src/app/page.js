  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        className={`px-2 py-1 rounded text-xs font-medium transition-colors duration-200 ${locale === 'en' ? 'bg-blue-600 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'}`}
      >
        EN
      </button>
      <button
        onClick={() => setLocale('ru')}
        className={`px-2 py-1 rounded text-xs font-medium transition-colors duration-200 ${locale === 'ru' ? 'bg-blue-600 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'}`}
      >
        RU
      </button>
    </div>
      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-400 outline-none focus:border-blue-400 transition-colors duration-200"
            value={url}
        ...
        <button
          ...
          className="w-full py-3 bg-blue-500 hover:bg-blue-400 text-black font-bold rounded-xl transition-colors duration-300 disabled:opacity-50 flex items-center justify-center gap-2"
        >
        ...
        <div className="text-center pt-8 border-t border-slate-800 space-y-2">
          ...
          <a
            ...
            className="text-blue-400 hover:underline inline-flex items-center gap-1 transition-colors duration-200"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-400 hover:underline text-sm inline-flex items-center gap-1 transition-colors duration-200"
          >
